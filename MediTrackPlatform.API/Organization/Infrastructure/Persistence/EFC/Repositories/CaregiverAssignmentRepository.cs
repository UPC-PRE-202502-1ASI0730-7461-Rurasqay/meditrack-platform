using MediTrackPlatform.API.Organization.Domain.Model.Entities;
...
public class CaregiverAssignmentRepository(AppDbContext context)
: BaseRepository<CaregiverAssignment>(context), ICaregiverAssignmentRepository;