    ...
    : IAdminCommandService
{
    ...
    public async Task<Admin?> Handle(UpdateAdminCommand command)
    {
        ...
        if (result.Result is null) throw new Exception(); // TODO: Use custom exceptions

        var adminToUpdate = result.Result;
        // TODO: Update Admin and return it!
        return null;
    }

    public Task Handle(DeleteAdminCommand command)
    {
        // TODO: Implement this handle.
